...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		{
			modelRadarManage.GET("/manage", controller.GetModelRadarManagement)
			modelRadarManage.POST("/sync", controller.TriggerModelRadarSync)
		}
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.GET("/chat-presets", middleware.DisableCache(), controller.GetUserChatPresets)
				...
				selfRoute.PUT("/radar-auto-effort", controller.UpdateUserRadarAutoEffort)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/batch/assign", controller.AdminBatchAssignUserSubscriptions)
			subscriptionAdminRoute.POST("/batch/revoke", controller.AdminBatchRevokeUserSubscriptions)
			subscriptionAdminRoute.POST("/batch/reset", controller.AdminBatchResetUserSubscriptions)
		}
		...
		registerPromptAuditRoutes(apiRouter)
		...
		{
			systemUpdateRoute.GET("/check", controller.GetSystemUpdate)
			systemUpdateRoute.GET("/state", controller.GetSystemUpdateState)
