	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/model-route-candidates", controller.GetUserModelRouteCandidates)
				adminRoute.GET("/:id/model-routes", controller.GetUserModelRoutes)
				adminRoute.POST("/:id/model-routes", controller.CreateUserModelRoute)
				adminRoute.PUT("/:id/model-routes/:route_id", controller.UpdateUserModelRoute)
				adminRoute.DELETE("/:id/model-routes/:route_id", controller.DeleteUserModelRoute)
