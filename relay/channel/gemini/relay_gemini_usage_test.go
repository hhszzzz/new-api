...
func TestStreamResponseGeminiChat2OpenAIAttachesUsageMetadata(t *testing.T) {
	...
	withUsage, isStop := relayconvert.StreamResponseGeminiChat2OpenAI(&dto.GeminiChatResponse{
	...
	withoutUsage, _ := relayconvert.StreamResponseGeminiChat2OpenAI(&dto.GeminiChatResponse{
		Candidates: []dto.GeminiChatCandidate{{
			Content: dto.GeminiChatContent{
				Role:  "model",
				Parts: []dto.GeminiPart{{Text: "hello"}},
