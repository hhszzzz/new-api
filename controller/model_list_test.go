...
func setupModelListControllerTestDB(t *testing.T) *gorm.DB {
	...
	require.NoError(t, db.AutoMigrate(&model.User{}, &model.Channel{}, &model.Ability{}, &model.Model{}, &model.Vendor{}, &model.Option{}, &model.AuditLog{}, &model.UserSubscription{}))
...
func TestListModelsTokenLimitUsesResolvedCustomAutoGroups(t *testing.T) {
	...
	common.SetContextKey(emptyCtx, constant.ContextKeyUserGroups, []string{"default", "vip"})
	...
	common.SetContextKey(emptyCtx, constant.ContextKeyUserGroups, []string{"default"})
	common.SetContextKey(emptyCtx, constant.ContextKeyTokenModelLimitEnabled, true)
	common.SetContextKey(emptyCtx, constant.ContextKeyTokenModelLimit, map[string]bool{})
