	...
	return func(c *gin.Context) {
		...
		if err != nil {
			if errors.Is(err, model.ErrDatabase) {
				...
				abortWithProtocolMessage(c, http.StatusInternalServerError,
					common.TranslateMessage(c, i18n.MsgDatabaseError))
			} else {
				abortWithProtocolMessage(c, http.StatusUnauthorized,
		...
		if !userEnabled {
			abortWithProtocolMessage(c, http.StatusForbidden, common.TranslateMessage(c, i18n.MsgAuthUserBanned))
			return
		}
