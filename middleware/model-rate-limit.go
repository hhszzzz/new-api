...
func isResponsesWebSocketHandshake(c *gin.Context) bool {
	return c != nil && c.Request != nil && c.Request.URL != nil &&
		c.Request.Method == http.MethodGet && c.Request.URL.Path == "/v1/responses" &&
...
func ModelRequestRateLimit() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if apiErr != nil {
			abortWithProtocolMessage(c, apiErr.StatusCode, apiErr.Error(), apiErr.GetErrorCode())
			return
		}
		c.Next()
		commit(c.Writer.Status() < http.StatusBadRequest)
	}
}
