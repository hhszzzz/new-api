...
export function FloatingWindow(props: FloatingWindowProps) {
  ...
  const [lastExpandRequest, setLastExpandRequest] = useState(
    props.expandRequest
  )
  if (props.expandRequest !== lastExpandRequest) {
    setLastExpandRequest(props.expandRequest)
    if (props.expandRequest !== undefined && state.collapsed) {
