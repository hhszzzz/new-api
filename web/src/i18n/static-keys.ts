...
export const STATIC_I18N_KEYS = [
  ...
  'Model Square',
  'Rankings',
  'Hourly token usage by model for today',
  ...
  'Token share by model author for today',
  ...
  'Token usage by model across the selected date range',
  'Token share by model author across the selected date range',
  'Docs',
  'About',
