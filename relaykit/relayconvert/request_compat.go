...
func ClaudeMessagesRequestToOpenAIChatWithContext(c context.Context, claudeRequest dto.ClaudeRequest, info convmeta.Meta) (*dto.GeneralOpenAIRequest, error) {
	return convertCompatRequest[dto.GeneralOpenAIRequest](c, info, types.RelayFormatOpenAI, &claudeRequest)
}
...
func RecordGeminiReasoningEffort(geminiRequest *dto.GeminiChatRequest, info convmeta.Meta) {
