...
// AttachQuotaSaturation exposes the shared quota-saturation audit step to
// controllers that write consume logs outside the standard billing flow.
func AttachQuotaSaturation(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, other *model.LogOther) {
...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if !relayInfo.StartTime.IsZero() {
		...
		other.SetPublic("duration_ms", durationMs)
	}
